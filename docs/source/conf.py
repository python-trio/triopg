...
project = 'triopg'
copyright = 'The triopg authors'
author = 'The triopg authors'
...
latex_documents = [
    (master_doc, 'triopg.tex', 'Trio Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'triopg', 'triopg Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'triopg', 'triopg Documentation',
     author, 'triopg', 'PostgreSQL client for Trio based on asyncpg',
     'Miscellaneous'),
]
